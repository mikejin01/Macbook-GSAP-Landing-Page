...
const featureSequence = [
    ...
    { videoPath: asset("/videos/feature-2.mp4"), boxClass: ".box2", delay: 0 },
    { videoPath: asset("/videos/feature-3.mp4"), boxClass: ".box3", delay: 0 },
    { videoPath: asset("/videos/feature-4.mp4"), boxClass: ".box4", delay: 0 },
    { videoPath: asset("/videos/feature-5.mp4"), boxClass: ".box5", delay: 0 },
];
